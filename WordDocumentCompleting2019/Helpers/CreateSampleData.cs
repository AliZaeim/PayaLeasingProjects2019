...
namespace WordDocumentCompleting2019.Helpers
{
    ...
    {
        public static List<TemplateModel> CreateCarInstallmentData()
        {
        ...
        public static List<TemplateModel> CreateCreditFacilityData()
        {
            List<TemplateModel> templateModels = new List<TemplateModel>()
            {
        ...
        public static List<TemplateModel> CreateAttachmentNo1Data()
        {
            List<TemplateModel> templateModels = new List<TemplateModel>()
            {
                #region header
        ...
        public static List<TemplateModel> CreateSalesFormData()
        {
            List<TemplateModel> templateModels = new List<TemplateModel>()
            {
                #region header
        ...
        public static List<TemplateModel> CreateVehicleDeliveryaFormData()
        {
            List<TemplateModel> templateModels = new List<TemplateModel>()
            {
                #region header
        ...
        public static List<TemplateModel> CreateGoodDeliveryFormData()
        {
            List<TemplateModel> templateModels = new List<TemplateModel>()
            {
                new TemplateModel()
